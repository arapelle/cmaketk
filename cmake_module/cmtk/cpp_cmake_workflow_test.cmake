...
function(cmtk_add_cpp_cmake_workflow_gtests project gtest_target)
    # Args:
    set(options "")
    set(params "TARGET;TEST_SOURCE;CXX_STANDARD;SOURCE_DIR;BUILD_DIR;INSTALL_DIR;TEST_PACKAGE_SOURCE_DIR;TEST_PACKAGE_BUILD_DIR;PACKAGE_TYPE;UNINSTALL_SCRIPT_SUBPATH;CMAKETK_TARGET")
    ...
    cmtk_set_ifndef(ARG_CMAKETK_TARGET "cmake_cpptk::cmake_cpptk")
    cmtk_assert(TARGET ${gtest_target})
    cmtk_assert(TARGET ${ARG_CMAKETK_TARGET})
    ...
    target_link_libraries(${ARG_TARGET} PRIVATE ${gtest_target} ${ARG_CMAKETK_TARGET} ${ARG_LINK_LIBRARIES})
