...
function(cmtk_shared_or_static_option cache_var_name shared_or_static)
  cmtk_fatal_if_none_of(shared_or_static "SHARED" "STATIC")
...
function(_cmtk_add_honly_cpp_library library_name)
    ...
    cmtk_fatal_ifndef("You must provide header files (HEADERS)." ARG_HEADERS)
...
function(_cmtk_add_compiled_cpp_library target_name library_type)
  ...
  if(ARG_DEFAULT_WARNING_OPTIONS)
    cmtk_target_default_warning_options(${target_name})
  endif()
  if(ARG_DEFAULT_ERROR_OPTIONS)
    cmtk_target_default_error_options(${target_name})
  endif()
...
function(cmtk_add_cpp_library target_name library_type)
...
include(${CMAKE_CURRENT_LIST_DIR}/cpp_lib_example.cmake)
