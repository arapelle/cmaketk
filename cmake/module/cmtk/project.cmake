...
function(set_project_semantic_version numver)
    # Args:
    set(options "")
    ...
    cmake_parse_arguments(PARSE_ARGV 0 "ARG" "${options}" "${params}" "${lists}")
    #:
    set(PROJECT_VERSION "${numver}" PARENT_SCOPE)
    set(semantic_version "${numver}")
...
function(configure_files return_var)
  ...
  fatal_ifndef("You must provide a source base directory (BASE_DIR)." ARG_BASE_DIR)
...
# Macro: cmtk_add_test_subdirectory_if_build
