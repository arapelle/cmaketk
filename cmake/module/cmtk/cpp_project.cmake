...
function(cmtk_configure_headers return_var)
  ...
  cmtk_set_ifndef(ARG_BASE_DIR ${CMAKE_INSTALL_INCLUDEDIR})
  cmtk_set_ifndef(ARG_BINARY_BASE_DIR "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_INSTALL_INCLUDEDIR}")
  cmtk_configure_files(configured_files BASE_DIR "${ARG_BASE_DIR}" BINARY_BASE_DIR "${ARG_BINARY_BASE_DIR}" FILES ${ARG_FILES})
...
function(cmtk_configure_sources return_var)
  cmake_parse_arguments(PARSE_ARGV 1 "ARG" "" "BASE_DIR;BINARY_BASE_DIR" "FILES")
  cmtk_fatal_ifndef("You must provide files to configure (FILES)." ARG_FILES)
  cmtk_set_ifndef(ARG_BASE_DIR "src")
  cmtk_set_ifndef(ARG_BINARY_BASE_DIR "${CMAKE_CURRENT_BINARY_DIR}/src")
  cmtk_configure_files(configured_files BASE_DIR "${ARG_BASE_DIR}" BINARY_BASE_DIR "${ARG_BINARY_BASE_DIR}" FILES ${ARG_FILES})
  set(${return_var} "${configured_files}" PARENT_SCOPE)
endfunction()
...
function(cmtk_cxx_standard_option cxx_std_var_name)
    ...
    cmtk_set_ifndef(ARG_MIN ${default_min})
    cmtk_set_ifndef(ARG_MAX ${default_max})
    ## check MIN
    ...
    if(${CMAKE_CXX_STANDARD})
      cmtk_set_ifndef(ARG_DEFAULT ${CMAKE_CXX_STANDARD})
    else()
      cmtk_set_ifndef(ARG_DEFAULT ${ARG_MIN})
    endif()
    ## check DEFAULT
