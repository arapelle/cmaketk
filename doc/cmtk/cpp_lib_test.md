...
## Include
`find_package(cmaketk COMPONENTS cpp_lib_project)`

## Library Test Functions

### Function `add_cpp_library_gtest(test_name library_target gtest_target ...)`
...
### Function `add_cpp_library_basic_gtests(library_target gtest_target ...)`
