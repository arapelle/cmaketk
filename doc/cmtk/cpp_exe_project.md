...
# Cpp Executable Project

## Include
`find_package(cmaketk COMPONENTS cpp_exe_project)`

cpp_exe_project includes cpp_lib_test.
...
- MAIN_SOURCE *main_cpp_file*: 	The main source file of the target.
