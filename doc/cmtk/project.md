...
## Include
`find_package(cmaketk COMPONENTS project)`
...
### Function `cmtk_set_project_name()`
...
### Function `cmtk_set_package_name()`
...
### Function `cmtk_set_project_semantic_version(basicver)`
...
### Function `cmtk_set_package_semantic_version(basicver)`
...
### Function `cmtk_install_cpp_targets(...)`
...
- *package_type* :  Type of the installed package: BIN or LIB.
